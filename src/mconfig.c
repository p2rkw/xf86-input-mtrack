...
void mconfig_defaults(struct MConfig* cfg)
{
	...
	cfg->scroll.up_hold = DEFAULT_SCROLL_HOLD;
	cfg->scroll.dn_hold = DEFAULT_SCROLL_HOLD;
	cfg->scroll.lt_hold = DEFAULT_SCROLL_HOLD;
	cfg->scroll.rt_hold = DEFAULT_SCROLL_HOLD;
	...
	cfg->swipe3.up_hold = DEFAULT_SWIPE_HOLD;
	cfg->swipe3.dn_hold = DEFAULT_SWIPE_HOLD;
	cfg->swipe3.lt_hold = DEFAULT_SWIPE_HOLD;
	cfg->swipe3.rt_hold = DEFAULT_SWIPE_HOLD;
	...
	cfg->swipe4.up_hold = DEFAULT_SWIPE_HOLD;
	cfg->swipe4.dn_hold = DEFAULT_SWIPE_HOLD;
	cfg->swipe4.lt_hold = DEFAULT_SWIPE_HOLD;
	cfg->swipe4.rt_hold = DEFAULT_SWIPE_HOLD;
			...
			pointer opts)
{
	...
	cfg->scroll.up_hold = MAXVAL(xf86SetIntOption(opts, "ScrollUpClickTime", DEFAULT_SCROLL_HOLD), 0);
	cfg->scroll.dn_hold = MAXVAL(xf86SetIntOption(opts, "ScrollDownClickTime", DEFAULT_SCROLL_HOLD), 0);
	cfg->scroll.lt_hold = MAXVAL(xf86SetIntOption(opts, "ScrollLeftClickTime", DEFAULT_SCROLL_HOLD), 0);
	cfg->scroll.rt_hold = MAXVAL(xf86SetIntOption(opts, "ScrollRightClickTime", DEFAULT_SCROLL_HOLD), 0);
	...
	cfg->swipe3.up_hold = MAXVAL(xf86SetIntOption(opts, "SwipeUpClickTime", DEFAULT_SWIPE_HOLD), 0);
	cfg->swipe3.dn_hold = MAXVAL(xf86SetIntOption(opts, "SwipeDownClickTime", DEFAULT_SWIPE_HOLD), 0);
	cfg->swipe3.lt_hold = MAXVAL(xf86SetIntOption(opts, "SwipeLeftClickTime", DEFAULT_SWIPE_HOLD), 0);
	cfg->swipe3.rt_hold = MAXVAL(xf86SetIntOption(opts, "SwipeRightClickTime", DEFAULT_SWIPE_HOLD), 0);
	...
	cfg->swipe4.up_hold = MAXVAL(xf86SetIntOption(opts, "Swipe4UpClickTime", DEFAULT_SWIPE_HOLD), 0);
	cfg->swipe4.dn_hold = MAXVAL(xf86SetIntOption(opts, "Swipe4DownClickTime", DEFAULT_SWIPE_HOLD), 0);
	cfg->swipe4.lt_hold = MAXVAL(xf86SetIntOption(opts, "Swipe4LeftClickTime", DEFAULT_SWIPE_HOLD), 0);
	cfg->swipe4.rt_hold = MAXVAL(xf86SetIntOption(opts, "Swipe4RightClickTime", DEFAULT_SWIPE_HOLD), 0);
