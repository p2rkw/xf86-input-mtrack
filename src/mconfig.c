...
void mconfig_defaults(struct MConfig* cfg)
{
	...
	cfg->scroll.is_drag = DEFAULT_SWIPE_DRAG;
	...
	cfg->swipe3.hold = DEFAULT_SWIPE_HOLD;
   	cfg->swipe3.is_drag = DEFAULT_SWIPE_DRAG;
	...
	cfg->swipe4.is_drag = DEFAULT_SWIPE_DRAG;
			...
			pointer opts)
{
	...
	cfg->scroll.is_drag = MAXVAL(xf86SetIntOption(opts, "ScrollDrag", DEFAULT_SWIPE_DRAG), 0);
	...
	cfg->swipe3.hold = MAXVAL(xf86SetIntOption(opts, "SwipeClickTime", DEFAULT_SWIPE_HOLD), 0);
   	cfg->swipe3.is_drag = MAXVAL(xf86SetIntOption(opts, "SwipeDrag", DEFAULT_SWIPE_DRAG), 0);
	...
	cfg->swipe4.is_drag = MAXVAL(xf86SetIntOption(opts, "Swipe4Drag", DEFAULT_SWIPE_DRAG), 0);
