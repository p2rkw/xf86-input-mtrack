...
void mconfig_defaults(struct MConfig* cfg)
{
	...
	cfg->is_button_zones_limited = DEFAULT_IS_BUTTON_ZONES_LIMITED;
			...
			pointer opts)
{
	...
	cfg->is_button_zone_limited = xf86SetBoolOption(opts, "LimitButtonZone", DEFAULT_IS_BUTTON_ZONES_LIMITED);
